...
__author__ = "Originally Shawn Bruce <kantlivelong@gmail.com>, forked by SimplyPrint"
...
class SimplyPowerController(octoprint.plugin.StartupPlugin,
    ...
    def get_update_information(self):
        return dict(
            simplypowercontroller=dict(
                displayName="SimplyPowerController",
                displayVersion=self._plugin_version,

                # version check: github repository
                type="github_release",
                user="SimplyPrint",
                repo="OctoPrint-SimplyPowerController",
...
def __plugin_load__():
    ...
    __plugin_implementation__ = SimplyPowerController()
